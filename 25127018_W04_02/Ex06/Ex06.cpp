...
public:
    int countPairs(vector<int>& nums, int target) {
    	//Time Comp: O(n*n) because I searched through all pairs of the array, Space Comp: O(1)
...
//test case 2: negative nums and target
//[-6,-2,-5,-2,-7,-1,-3] -2
//Ans: 21

//test case 3: positive case and target
//[2,3,5,1,21,23,18] 12
//Ans: 6
